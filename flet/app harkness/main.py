...
def main(page: ft.Page):
    ...
    def route_change(event):
        ...
        elif event.route == "/admin/categorias":
            page.views.clear()
            page.views.append(ft.View(route="/admin/categorias", controls=[admin_categorias_page(page)]))
        elif event.route == "/admin/enlaces":  # <-- Nueva ruta para enlaces
            page.views.clear()
            page.views.append(ft.View(route="/admin/enlaces", controls=[admin_enlaces_page(page)]))
        else:
